...
const convert_to_half_width_kana = (str = '') => {
    ...
    const half_width_kana_pattern = _ts_buildPattern(_TS_HALF_WIDTH_KANA_MAP.keys());
    return _ts_replace_with_map(str, half_width_kana_pattern, _TS_HALF_WIDTH_KANA_MAP);
};
